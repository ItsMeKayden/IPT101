    ...
    <div className="mt-1 p-4 font-['cinzel'] overflow-x-hidden">
      <div className="w-full max-w-[1220px] ml-[60px]">
          ...
          <div className="absolute top-[10px] right-[10px] w-[70%] h-[115px] bg-[#EED2E0] rounded-[20px] flex items-center justify-center gap-4 md:gap-20 shadow-[inset_0_4px_4px_rgba(0,0,0,0.25)] hover:bg-[#d6b9d6] transition-all duration-300">
            {stockIcons.map((icon, index) => (  
              <div key={index} className="flex items-center group">
                <img
                  className="w-[45px] h-[45px] md:w-[60px] md:h-[60px] object-contain group-hover:scale-110 transition-transform duration-300"
                  src={`/icons/${icon}`}
                  alt={`Stock ${index}`}
                />
                <div className="ml-2 md:ml-4 font-bold text-[#65366F] text-[40px] md:text-[50px] group-hover:text-[#552e5e] transition-colors duration-300">
                  100
                </div>
              </div>
            ))}
        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full">
          ...
          <div className="w-full lg:w-[40%] rounded-[20px] shadow-lg flex items-center justify-center p-4" style={{ background: 'linear-gradient(135deg, #D1C6F3 0%, #E9BCAC 100%)' }}>
